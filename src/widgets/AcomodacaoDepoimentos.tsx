        ...
        <div className="w-full py-4">
            ...
            {depoimentos.map( (depoimento, indice) => (
                <div className="flex gap-2 py-4 items-start" key={indice}>
                    <Image className="rounded-full aspect-square object-cover " src={depoimento.image} width={48} height={48} alt={depoimento.name} />
                    <div>
                        <span className="text-base font-semibold" >{depoimento.name}</span>
